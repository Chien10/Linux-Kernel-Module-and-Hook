...
static int __init ebbchar_init(void)
{
	...
	majorNumber = register_chdev(0, DEVICE_NAME, &fops);
	if (majorNumber < 0)
	{
	...
	{
		unregister_chdev(majorNumber, DEVICE_NAME);
...
static ssize_t dev_read(struct file *filep, char *buffer, ssize_t len, loff_t *offset)
{
